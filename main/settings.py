...
LOL_URL = {
    ...
    'STATIC_SPELL_ALL_DATA':
    'http://ddragon.leagueoflegends.com/cdn/%s/data/ko_KR/summoner.json',
    'SPELL_ICON':
    'http://ddragon.leagueoflegends.com/cdn/%s/img/spell/%s.png',
    'ITEM_ICON':
    'http://ddragon.leagueoflegends.com/cdn/%s/img/item/%d.png',
}
